...
public class NlEmployeeManagementAssessmentController extends JeecgController<NlEmployeeManagementAssessment, INlEmployeeManagementAssessmentService> {
	...
	public Result<String> add(@RequestBody NlEmployeeManagementAssessment nlEmployeeManagementAssessment) {
	...
	public Result<String> edit(@RequestBody NlEmployeeManagementAssessment nlEmployeeManagementAssessment) {
