package org.jeecg.modules.demo.nl_politics_reply.entity;
 ...
 */
@Data
@TableName("nl_employee_politics_request_reply")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="nl_employee_politics_request_reply对象", description="思想状态回答表")
public class NlEmployeePoliticsRequestReply implements Serializable {
