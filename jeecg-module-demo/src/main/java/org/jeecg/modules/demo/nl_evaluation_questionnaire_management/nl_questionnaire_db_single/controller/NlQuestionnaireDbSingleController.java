package org.jeecg.modules.demo.nl_evaluation_questionnaire_management.nl_questionnaire_db_single.controller;
...
import org.jeecg.modules.demo.nl_evaluation_questionnaire_management.nl_questionnaire_db_single.entity.NlQuestionnaireDbSingle;
import org.jeecg.modules.demo.nl_evaluation_questionnaire_management.nl_questionnaire_db_single.service.INlQuestionnaireDbSingleService;
...
@Api(tags = "问卷题库管理")
@RestController
@RequestMapping("/nl_evaluation_questionnaire_management/nl_questionnaire_db_single/nlQuestionnaireDbSingle")
@Slf4j
public class NlQuestionnaireDbSingleController extends JeecgController<NlQuestionnaireDbSingle, INlQuestionnaireDbSingleService> {
    ...
    @AutoLog(value = "问卷题库管理-根据类型查询")
    @ApiOperation(value = "问卷题库管理-根据类型查询")
    @GetMapping(value = "/listByType")
    public Result<IPage<NlQuestionnaireDbSingle>> queryPageListByType(NlQuestionnaireDbSingle nlQuestionnaireDbSingle,
                                                                      @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
                                                                      @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
                                                                      HttpServletRequest req) {
        QueryWrapper queryWrapper = QueryGenerator.initQueryWrapper(nlQuestionnaireDbSingle,req.getParameterMap());
        Page<NlQuestionnaireDbSingle> page = new Page<>(pageNo, pageSize);
        IPage<NlQuestionnaireDbSingle> pageList = nlQuestionnaireDbSingleService.page(page, queryWrapper);
        return Result.ok(pageList);
    }
    ...
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:add")
    ...
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:edit")
    ...
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:delete")
    ...
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:deleteBatch")
     ...
     * @param nlQuestionnaireDbSingle
     */
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:exportXls")
     ...
     * @return
     */
    @RequiresPermissions("nl_evaluation_questionnaire_management/nl_questionnaire_db_single:nl_questionnaire_db_single:importExcel")
