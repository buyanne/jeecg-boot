...
public class NlEmployeeReviewController extends JeecgController<NlEmployeeReview, INlEmployeeReviewService> {
	...
	public Result<IPage<NlEmployeeReview>> queryPageList(NlEmployeeReview nlEmployeeReview,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<NlEmployeeReview> queryWrapper = QueryGenerator.initQueryWrapper(nlEmployeeReview, req.getParameterMap());
		Page<NlEmployeeReview> page = new Page<NlEmployeeReview>(pageNo, pageSize);
		IPage<NlEmployeeReview> pageList = nlEmployeeReviewService.page(page, queryWrapper);
